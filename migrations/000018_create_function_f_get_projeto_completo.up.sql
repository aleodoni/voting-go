-- ===============================================
-- Função: f_get_projeto_completo (idempotente)
-- ===============================================

CREATE OR REPLACE FUNCTION public.f_get_projeto_completo(p_projeto_id varchar)
RETURNS jsonb
LANGUAGE sql
AS $$
SELECT coalesce(projeto_json, '{}'::jsonb)
FROM (
